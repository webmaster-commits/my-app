export const metadata = {{ title: "Buy YouTube Likes — Likes.io" }};

export default function Page() {{
  const packages = ["100", "500", "1,000", "2,500", "5,000"];
  return (
    <section className="container-balanced py-16">
      <h1 className="text-3xl font-bold">Buy YouTube Likes</h1>
      <p className="mt-2 text-slate-600 dark:text-slate-300">
        Encourage algorithmic reach with stable likes.
      </p>
