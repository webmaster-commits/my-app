export const metadata = {{ title: "Buy Instagram Followers — Likes.io" }};

export default function Page() {{
  const packages = ["100", "500", "1,000", "2,500", "5,000"];
  return (
    <section className="container-balanced py-16">
      <h1 className="text-3xl font-bold">Buy Instagram Followers</h1>
      <p className="mt-2 text-slate-600 dark:text-slate-300">
        Real profiles, instant start, safe speed, and refill options.
      </p>
